...
// Errori: manca una virgola nel penultimo oggetto, tutti gli auto vanno sostituiti con cars, nel filter la funzione freccia ha la sintassi ">=" invece di "=>", il return del filter deve essere && non || poiché non voglio né le auto diesel né le auto a benzina, siccome benzina e diesel hanno l'iniziale alle volte minuscola e alle volte maiuscola la convertiamo col metodo toLowerCase() in minuscolo. L'ultimo errore è che il filter salvato nella variabile dieselCars non aveva un return, per cui non ritornava niente
